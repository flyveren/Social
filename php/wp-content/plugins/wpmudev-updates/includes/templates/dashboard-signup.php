...
?>
	<section id="profile" class="api-key-form step1">
		<form id="api-signup" class="clearfix" action="<?php echo $this->server_url . '?action=register-new'; ?>" method="post"<?php echo (isset($_GET['api_error'])  || isset($_GET['clear_key']) || (isset($key_valid) && !$key_valid)) ? ' style="display:none;"' : ''; ?>>
			<fieldset>
				<legend>
